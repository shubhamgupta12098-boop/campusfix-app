...
export const config = {
  ...
  mongoUri: process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/ccmms',
  ...
  appBaseUrl: String(process.env.APP_BASE_URL || process.env.RENDER_EXTERNAL_URL || `http://localhost:${process.env.PORT || 3000}`).replace(/\/$/, ''),
