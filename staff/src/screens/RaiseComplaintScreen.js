    ...
    return (<div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <Card className="p-5">
          ...
          <p className="text-xs text-slate-500 mb-1">At least 1 Photo * is mandatory. Video is optional and can also be uploaded.</p>
          <p className="text-xs font-semibold text-red-600 mb-4">Required * · Maximum {MAX_MEDIA} files</p>

          <input ref={cameraInputRef} type="file" accept="image/*" capture="environment" className="sr-only" onChange={handleMediaUpload} aria-label="Take photo"/>
