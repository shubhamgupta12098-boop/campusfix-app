...
import { ClipboardList, CheckCircle2, Clock, AlertTriangle, PlusCircle, ArrowRight, Wrench, Users, UserCog, Building2, Bell, ShieldCheck, } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
          <Card className="p-5 xl:col-span-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
              {statusPipeline.map((stage, index) => (<div key={stage.key} className="relative rounded-xl bg-slate-50 border border-slate-100 p-4 text-center">
