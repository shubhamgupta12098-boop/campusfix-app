...
import { User, Mail, Phone, Building2, Home, DoorOpen, BadgeCheck, Shield, Edit3, X, Save, ClipboardList, CheckCircle2, Clock, Star, Wrench, TrendingUp, Calendar, Award, Activity, KeyRound, Lock, Eye, EyeOff, Moon, Sun, } from 'lucide-react';
const ROLE_LABELS = {
    student: 'Student',
    staff: 'Staff',
    admin: 'Administrator',
              ...
              {pwSuccess ? (<div className="text-center py-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                        <Lock className="w-4 h-4 text-slate-400 flex-shrink-0"/>
                        <input type={showPw ? 'text' : 'password'} value={pwForm.new} onChange={(e) => setPwForm({ ...pwForm, new: e.target.value })} required minLength={6} placeholder="••••••••" className="w-full bg-transparent outline-none text-sm text-slate-900"/>
